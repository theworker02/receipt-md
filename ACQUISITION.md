# Acquisition Brief â€” receipt-md

**Date:** 2026-09-22  
**Repository:** https://github.com/theworker02/receipt-md  
**Default branch:** `main`  
...
This project is **proprietary**. Production use, redistribution, and commercial deployment require a written commercial license or completed acquisition. See [LICENSE](./LICENSE) and [ACQUISITION.md](./ACQUISITION.md). Contact [@theworker02](https://github.com/theworker02). <img src="docs/logo.svg" alt="receipt-md mark" width="96" height="96"> **Generate durable PASS/FAIL markdown receipts with structured metadata and optional JSON sidecars.**

**Why a buyer cares:** receipt-md packages transferable product IP â€” source, docs, in-repo brand assets, and a diligence room under `docs/acquisition/` â€” under a clear proprietary posture so diligence can proceed without mistaking the repo for open source.
